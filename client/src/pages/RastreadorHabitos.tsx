/* =============================================================
   PÁGINA: Rastreador de Hábitos — Planner Digital Coelhinhos Kawaii
   ============================================================= */
    ...
    <div className="planner-page" style={{ minHeight: "100vh", background: "#FFF7EA" }}>
      ...
      <div style={{ background: "#BFD8B8", borderBottom: "3px solid #7BA87A", padding: "1.25rem 2rem" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
            <img src={CAPIVARA_HABITOS} alt="Coelhinho hábitos" style={{ width: 60, height: 60, objectFit: "contain" }} />
            <div>
      ...
      <div style={{ maxWidth: 1100, margin: "1.5rem auto 2rem", padding: "0 1.5rem", display: "flex", flexDirection: "column", gap: "1.5rem" }}>
        ...
        <div style={{ background: "linear-gradient(135deg, #F5EDE0, #FFF0D8)", borderRadius: "1.25rem", border: "2px solid #E8D5C0", padding: "1rem 1.5rem", display: "flex", gap: "0.75rem", alignItems: "center" }}>
          ...
          <div>
            <p style={{ fontWeight: 800, color: "#5B3A29", fontSize: "0.88rem", marginBottom: "0.1rem" }}>Dica do Coelhinho</p>
            <p style={{ color: "#8B6347", fontSize: "0.8rem", fontWeight: 500 }}>Comece com apenas 2-3 hábitos. Consistência é mais importante que quantidade. A coelhinho é calma e constante — seja como ela! 🌿</p>
          </div>
        </div>
