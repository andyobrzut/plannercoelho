/* =============================================================
   PÁGINA: Controle Financeiro — Planner Digital Coelhinhos Kawaii
   ============================================================= */
      ...
      <div style={{ background: "#B9DDE7", borderBottom: "3px solid #7BB8C8", padding: "1.25rem 2rem" }}>
        <div style={{ maxWidth: 900, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
            <img src={CAPIVARA_FINANCAS} alt="Coelhinho finanças" style={{ width: 60, height: 60, objectFit: "contain" }} />
            <div>
