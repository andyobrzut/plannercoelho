/* =============================================================
   PÁGINA: Planner Mensal — Planner Digital Coelhinhos Kawaii
   ============================================================= */
      ...
      <div style={{ background: "#BFD8B8", borderBottom: "3px solid #7BA87A", padding: "1.25rem 2rem" }}>
        <div style={{ maxWidth: 900, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
            <img src={CAPIVARA_CALENDARIO} alt="Coelhinho calendário" style={{ width: 60, height: 60, objectFit: "contain" }} />
            <div>
