...
const PRODUCT_SLUG = (import.meta.env.VITE_PRODUCT_SLUG as string | undefined) || "planner-rabbit-en";

const DEVICE_KEY = "planner_rabbit_en_device_id";
const ACTIVATION_KEY = "planner_rabbit_en_activation_id";
