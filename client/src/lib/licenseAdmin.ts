...
export const DEFAULT_PRODUCT_SLUG = (import.meta.env.VITE_PRODUCT_SLUG as string | undefined) || "planner-rabbit-en";
...
export function generateLicenseCode(prefix = "RABBIT") {
